...
Report bugs via [GitHub Issues](https://github.com/EliorMachlev/currencies/issues) with your Android version, app version (`Settings → About`), selected exchange rate provider, and steps to reproduce.
