...
class GraphOptionsDialog : AppCompatDialogFragment() {
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        bindSwitch(
            view,
            R.id.switch_grid,
            db::isChartGridEnabledBlocking,
            db::setChartGridEnabled,
        )
        bindSwitch(
            view,
            R.id.switch_x_axis,
            db::isChartXAxisLabelEnabledBlocking,
            db::setChartXAxisLabelEnabled,
        )
        bindSwitch(
            view,
            R.id.switch_y_axis,
            db::isChartYAxisLabelEnabledBlocking,
            db::setChartYAxisLabelEnabled,
        )
        bindSwitch(
            view,
            R.id.switch_highlight_extremes,
